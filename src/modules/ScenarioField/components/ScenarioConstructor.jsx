...
const ScenarioConstructor = () => {
    return(
        <div className="bg-zinc-200 border border-dashed border-zinc-400 mx-3 rounded-lg shadow-sm hover:shadow-xl hover:bg-zinc-300 hover:border-zinc-500 duration-150">
